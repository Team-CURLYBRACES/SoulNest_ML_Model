...
Make shure to have a location `/var/www/python/SoulNest_ML_Model` in vps and the docker images in your docker hub like `registry.example.com/flaskapp:latest`
